...
#' Users may select from a text table (a [pander::pander()] object) or as a
#' graphic, a [gridExtra::tableGrob()] object
#' 
...
#' @param ... other arguments passed to [gridExtra::ttheme_default()]
#' @examples 
#' # locate system file for import
#' Ps <- system.file("extdata", "practice_data_set.csv", package = "hagis")
#'
