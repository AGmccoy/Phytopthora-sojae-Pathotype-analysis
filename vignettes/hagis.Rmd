...
Once again, using _pander_ we can make these tables much more attractive in RMarkdown. Since `complexities` is a `list()` object, we can refer to each object directly by name and print them as follows.
