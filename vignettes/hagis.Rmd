...
First you'll want to load in your data set, for right now let's use a practice data set made for the _hagis_ package and name it `Pathotype.Data`:
...
## Important Terms Used in _hagis's_ Functions
...
* `perc_susc` refers to the column header for the column which identifies the percent susceptible plants for each gene
...
# using the pander library we can make the table much more attractive in Markdown
library(pander)
