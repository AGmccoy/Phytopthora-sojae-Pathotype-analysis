...
Two functions are provided to plot the summary depending on your needs. If you need the frequency, use `plot(Rps.summary, type = "percentage")`, or if you desire the distribution `plot(Rps.summary, type = "count")`. Both return the same graph, only the y-axis change; percent for frequency and n for distribution.
...
An isolates pathotype complexity refers to the number of resistance genes that it is able to overcome and cause idsease on. i,e, a pathotype complexity of 7 would mean that isolate can cause disease on 7 different resistance genes.
...
Two functions are provided to plot the complexities depending on your needs. If you need the frequency, use `plot(complexties, type = "percentage")`, or if you desire the distribution `plot(complexities, type = "count")`. Both return the same graph, only the y-axis change; percent for frequency and n for distribution.
