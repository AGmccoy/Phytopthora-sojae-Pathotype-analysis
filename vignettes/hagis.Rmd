...
Generate a summary plot of percentage susceptible:
...
You can use named, *e.g.* "red", "yellow", "blue" colors in R or you can use custom hexadecimal color codes. Illustrated below is using MSU Green, #18453b with a serif font.
