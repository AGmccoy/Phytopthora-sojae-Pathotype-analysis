...
These example data are included in _hagis_ and so when loading _hagis_ they become available in your R session.
...
Set up the _hagis_ arguments for analysis.
